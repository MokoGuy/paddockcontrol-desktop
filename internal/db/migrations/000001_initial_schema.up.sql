-- Initial database schema for PaddockControl Desktop
-- Adapted from webapp: removes status column (computed), adds is_configured flag
...
-- Status is computed dynamically based on certificate/CSR presence, not stored
